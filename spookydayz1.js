...
function init() {
	...
	spoky.id = "spookyi";
	$("body").append(spoky);
	$("#spookyi").css({"width":"26%", "height":"3%", "background":"#d2a990","color":"white", "position":" relative", "bottom":"-22px", "left":"2px", "z-index":"1", "opacity":"0.6", "overflow-x":"hidden", "overflow-y":"scroll "}) ;
